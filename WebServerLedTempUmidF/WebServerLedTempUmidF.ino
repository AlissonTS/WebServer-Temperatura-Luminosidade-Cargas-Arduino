...
// #include <Ethernet2.h> //Inclui a biblioteca Ethernet2.h
    ...
    while (client.connected())
    {
      ...
      if (client.available())
      {
        ...
        if (c == '\n' && currentLineIsBlank)
        {
          ...
          client.println(F("<BR><center></B></I></U><h2>- Gerenciamento de Carga/Temperatura e Umidade/Luminosidade - </h2></B></I></U></center>"));
          //=========================================================================================================================
          ...
          client.print(F("<center><button onclick=\"window.location.href='http://192.168.90.215/0001'\">\0</button> > Codigo: 0001 > "));
          if(A1_estado)
          {            
            client.print(F("<B><span style=\"color: #00ff00;\">"));   
            client.print(F("LED Verde - ON"));     
            client.print(F("</span></B></center>"));
          }         
          else
          {
            client.print(F("<B><span style=\"color: #ff0000;\">"));
            client.print(F("LED Verde - OFF"));
            client.print(F("</span></B></center>"));
          }
          //=========================================================================================================================
          ...
          //Segundo BOTAO - Temperatura
          client.print(F("<center><button onclick=\"window.location.href='http://192.168.90.215/0010'\">\0</button> > Codigo: 0010 > "));
          if(Tmp)
          {
          ...
          //Terceiro BOTAO - Umidade
          client.print(F("<center><button onclick=\"window.location.href='http://192.168.90.215/0011'\">\0</button> > Codigo: 0011 > "));
          if(Umd)
          {
          ...
          //Quarto BOTAO - Luminosidade
          client.print(F("<center><button onclick=\"window.location.href='http://192.168.90.215/0100'\">\0</button> > Codigo: 0100 > "));
          if(Lmd)
          {
